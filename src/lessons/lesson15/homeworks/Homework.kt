...
open class Quadrilateral(val a: Double, val b: Double, val c: Double, val d: Double) : Polygon("Quadrilateral", 4) {
    override fun perimeter() = a + b + c + d
}

class Rectangle(val width: Double, val height: Double) : Quadrilateral(width, height, width, height) {
...
class ResearchUniversity(title: String, city: String, faculties: Int, val hIndex: Double) : University(title, city, faculties)
...
class OfficeChair(model: String, material: String, hasArmrests: Boolean, val wheels: Int) : Chair(model, material, hasArmrests)

class GamingChair(model: String, material: String, hasArmrests: Boolean, val reclineDeg: Int) : Chair(model, material, hasArmrests)
...
class DiningTable(model: String, material: String, length: Double, width: Double, val seats: Int) : Table(model, material, length, width)
